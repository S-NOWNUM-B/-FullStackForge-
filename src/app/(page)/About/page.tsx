...
const focusAreas = [
  ...
  "Работа с облачными сервисами и DevOps-практиками",
  "Изучение и внедрение современных frontend-подходов",
  "Проектирование и оптимизация баз данных",
  "Интеграция AI-инструментов в веб-проекты",
  "Разработка надёжных и масштабируемых backend-сервисов",
];
...
const skills = [
  ...
  {
    icon: Calendar,
    title: "Стратигическое планирование",
...
const competencies = [
  "Full-Stack разработка с использованием Python, Java, JavaScript и современных фреймворков",
  "Работа с SQL и NoSQL базами данных, проектирование и оптимизация запросов",
  "UX/UI дизайн, прототипирование и тестирование интерфейсов в Figma",
  "Опыт участия в разработке и поддержке корпоративных web-платформ",
          ...
          >
            <div className="h-full p-8 rounded-2xl bg-gradient-to-br from-gray-800/40 to-gray-900/40 border border-gray-700/50 backdrop-blur-sm">
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                Разработчик с фокусом на создание масштабируемых и надёжных web-приложений. Специализируюсь на полном цикле 
                разработки — от проектирования архитектуры и работы с базами данных до реализации удобных пользовательских 
                интерфейсов.Умею работать как в команде, так и самостоятельно, применяя современные технологии и лучшие практики.  
                Увлекаюсь настольными стратегиями вроде Warhammer, что помогает развивать стратегическое мышление и умение просчитывать шаги наперёд.  
                Люблю комиксы Marvel, в которых ценю продуманность сюжетов и внимание к деталям — эти качества стараюсь переносить и в работу.  
                Для меня важно сочетать техническую надёжность и креативный подход, чтобы проекты были не только функциональными, но и вдохновляющими.
              </p>
            </div>
          </motion.div>
        </div>
