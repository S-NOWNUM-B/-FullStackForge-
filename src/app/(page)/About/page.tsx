...
const focusAreas = [
  ...
  "Работа с MySQL и PostgreSQL: проектирование структуры данных и оптимизация производительности",
...
const competencies = [
  "Full-Stack разработка с использованием JavaScript/TypeScript (React, Next.js, Node.js), Python (FastAPI)",
  ...
  "Backend-разработка на Node.js/NestJS и FastAPI с проектированием REST API",
