...
const workProcess = [
  {
    step: "01",
    title: "Заявка",
    description: "Напишите мне на почту или в любой удобный мессенджер — расскажите о задаче, желаемых сроках и примерном бюджете, и мы обсудим детали."
  },
  {
    step: "02",
    title: "Созвон и бриф",
  ...
  },
  {
    ...
    description: "Фикс-пакет по багам в течение трёх дней, возможность заказать дальнейшую поддержку"
  }
];
...
const pricingInfo = [
  ...
  },
  {
    icon: Clock,
    title: "Сроки",
    value: "От 3 дней до 3 месяцев",
    description: "Экспресс-задачи за 3-5 дней, MVP за 2-4 недели, комплексные проекты до 3 месяцев"
  },
  {
    icon: Globe,
    title: "Часовой пояс",
...
const includedServices = [
  ...
  "Деплой на хостинг (Render, Vercel)",
  ...
  "Базовая защита от распространенных уязвимостей",
];

const excludedServices = [
  "Разработка полноценного фирменного стиля и брендбука",
  ...
  "Копирайтинг и написание текстового контента",
  "Миграция данных из старых систем",
  "Долгосрочное сопровождение после гарантийного периода",
];

const workFormats = [
  "Гибкие форматы сотрудничества под любые задачи",
  "Поэтапная разработка с промежуточными результатами",
  "Прозрачный процесс и регулярная отчетность",
  "Еженедельные созвоны и демонстрация прогресса",
  "Исходный код и документация в собственность",
  "Обучение работе с админ-панелью после запуска",
  "Консультации по техническим вопросам",
  "Фиксированная стоимость согласованного функционала"
];

const limitations = [
  "Проекты с неопределенными требованиями",
  "Задачи без технического задания и брифа",
  "Работа без договора и предоплаты",
  "Бесконечные правки за рамками ТЗ",
  "Проекты с нереалистичными сроками",
  "Копирование существующих сайтов и приложений",
  "Задачи, нарушающие авторские права",
  "Клиенты без обратной связи более 3 дней",
];
